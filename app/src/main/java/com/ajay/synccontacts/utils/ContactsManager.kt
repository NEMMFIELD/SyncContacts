    ...
    companion object {
        ...
        fun registerContact(context: Context, contact: Contact) {
            Log.d(
                ...
                "Before creation RawContactId for contact $contact to be registered"
            )
            ...
            for (number in contact.numbers) {
                 ...
                 */
                val newRawContactId =
                    contentProviderResult[0].uri?.let { ContentUris.parseId(it).toString() }
                Log.d(
                    ContactsManager::class.java.simpleName,
        ...
        fun registerNumber(
            ...
            Log.d(
                ContactsManager::class.java.simpleName,
                "Before creation RawContactId for number $number to be registered"
            )
            val operations = ArrayList<ContentProviderOperation>()
